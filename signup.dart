...
import 'package:today_my_school_2/models/model_auth.dart';
import 'package:today_my_school_2/models/model_signup.dart';
import 'package:today_my_school_2/models/model_user.dart';
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            validator: (email) {
              if (email!.trim().isEmpty || !email.contains('g.kmou.ac.kr')) {
